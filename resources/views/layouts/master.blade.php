      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="/adminlte/img/apotek.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs">Sistem Apotek Online</span>
            </a>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="/adminlte/img/apotek.jpg" class="img-circle" alt="User Image">
        </div>
        <div class="pull-left info">
          <p>Sistem Apotek Online</p>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-edit"></i> <span>Detail Penjualan</span>
            <span class="pull-right-container">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-edit"></i> <span>Detail Supply</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="active"><a href="{{route('detailsupply.index')}}"><i class="fa fa-circle-o"></i> Data Detai Supply</a></li>
          </ul>
